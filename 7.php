...
<div class="w3-row">
<div id="valid" style="background:rgb(255, 51, 204);"class="w3-cell w3-content w3-col l4 m6 s12 w3-text-teal w3-round w3-hide">
...
<form method="post" action="9.php" onsubmit=" return myfunc()">
